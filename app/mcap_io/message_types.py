...
class FrameRecord:
    ...
    compressed_payload_size: int = 0   # raw bytes of compressed data (bonus: small payload)
    is_timestamp_anomaly: bool = False # bonus: set by pipeline if timestamp inconsistent
